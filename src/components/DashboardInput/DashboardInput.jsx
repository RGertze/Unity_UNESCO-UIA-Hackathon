    ...
    return (
        ...
        <div className="vert-flex justify-center" style={{ height: "60vh", alignItems: "center" }}>
            ...
            <div style={{
                ...
                <Form>
                    <h1 className="m-3">Employee Details</h1>
                    <Form.Group style={{ marginBottom: "20px" }} className="w-75 hor-center">
                        <Form.Label>Organization: </Form.Label>
                        <Form.Select  value={organisation} onChange={(e) => setOrganisation(e.target.value)} placeholder={"Enter Organization"} >
                            <option>Select Organization</option> 
                            <option>Department of Agriculture</option>    
                            <option>Department of Power</option>    
